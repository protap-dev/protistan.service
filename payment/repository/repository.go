...
// WithTransaction executes fn with a payment DB transaction and a core DB
// transaction for outbox writes. These are separate database transactions and
// do not provide distributed atomicity; payment outbox repair reconciles any
// completed payment state whose corresponding core outbox event was not
// committed.
